...
const squareClick = (cardElement, column, row) => {
  ...
  if (firstCard === null) {
    ...
    stateElement.innerText = 'You clicked your first card. Please click your second card.'
    ...
    if (
      ...
      stateElement.innerText += ' Oh no, it was not a match! Click another card to restart the matching.';
